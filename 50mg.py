...
data.to_csv("50mg.csv")

# stream = 5
    
# # plt.figure()
# # plt.plot(data[f'oxygen{stream}'])
# # plt.title('Venous Oxygen Over Time (50mg DNP)')
# # plt.xlabel('Time (hr)')
# # plt.ylabel('Molar Flow Rate (moles/hr)')
# # plt.grid(True)
# # plt.savefig(f"50mg-oxygen{stream}.png")

# # plt.figure()
# # plt.plot(data[f'co{stream}'])
# # plt.title('Venous Carbon Dioxide Over Time (50mg DNP)')
# # plt.xlabel('Time (hr)')
# # plt.ylabel('Molar Flow Rate (moles/hr)')
# # plt.grid(True)
# # plt.savefig(f"50mg-co{stream}.png")

# # plt.figure()
# # plt.plot(data[f'k{stream}'])
# # plt.title('Venous Potassium Over Time (50mg DNP)')
# # plt.xlabel('Time (hr)')
# # plt.ylabel('Molar Flow Rate (moles/hr)')
# # plt.grid(True)
# # plt.savefig(f"50mg-k{stream}.png")

# # plt.figure()
# # plt.plot(data[f'dnp{stream}'])
# # plt.title('Venous DNP Over Time (50mg DNP)')
# # plt.xlabel('Time (hr)')
# # plt.ylabel('Molar Flow Rate (moles/hr)')
# # plt.grid(True)
# # plt.savefig(f"50mg-dnp{stream}.png")

# fig, axes = plt.subplots(2, 2, figsize=(15, 8))

# ax = axes[0,0]
# ax.plot(data[f'oxygen{stream}'])
# ax.set_title('Venous Oxygen Over Time (50mg DNP)')
...
# ax.set_title('Venous Carbon Dioxide Over Time (50mg DNP)')
# ax.set_xlabel('Time (hr)')
# ax.set_ylabel('Molar Flow Rate (moles/hr)')
# ax.grid(True)
...
# ax.set_title('Venous Potassium Over Time (50mg DNP)')
# ax.set_xlabel('Time (hr)')
# ax.set_ylabel('Molar Flow Rate (moles/hr)')
# ax.grid(True)
...
# ax.set_title('Venous DNP Over Time (50mg DNP)')
# ax.set_xlabel('Time (hr)')
# ax.set_ylabel('Molar Flow Rate (moles/hr)')
# ax.grid(True)
